...
// MARK: - From Submissions/NaloxoneNow_AppClip/NaloxoneNow.swift
        ...
        VStack(spacing: 0) {
            ...
            HStack {
                VStack(alignment: .leading, spacing: 2) {
                    Text("In the event of an OVERDOSE EMERGENCY")
                        .font(.title2).bold()
...
// MARK: - From Submissions/NaloxoneNow_AppClip/OntarioNaloxoneKits.swift
